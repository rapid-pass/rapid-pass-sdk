...
export const ProcessorsApiFp = function(configuration?: Configuration) {
    return {
        ...
        async stripeControllerCreateStripeConnectAccount(merchantId: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<StripeLinkDto>>> {
            const localVarAxiosArgs = await ProcessorsApiAxiosParamCreator(configuration).stripeControllerCreateStripeConnectAccount(merchantId, options);
...
export const ProcessorsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
        ...
        async stripeControllerCreateStripeConnectAccount(merchantId: string, options?: AxiosRequestConfig): Promise<AxiosResponse<StripeLinkDto>> {
            return ProcessorsApiFp(configuration).stripeControllerCreateStripeConnectAccount(merchantId, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class ProcessorsApi extends BaseAPI {
    ...
    public async stripeControllerCreateStripeConnectAccount(merchantId: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<StripeLinkDto>> {
        return ProcessorsApiFp(this.configuration).stripeControllerCreateStripeConnectAccount(merchantId, options).then((request) => request(this.axios, this.basePath));
    }
}
