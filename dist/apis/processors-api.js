 ...
 * @export
 */
var ProcessorsApiAxiosParamCreator = function (configuration) {
    var _this = this;
    return {
        /**
         *
 ...
 * @export
 */
var ProcessorsApiFp = function (configuration) {
    return {
        /**
         *
         * @summary Create a new Stripe Connect account
        ...
        stripeControllerCreateStripeConnectAccount: function (merchantId, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, exports.ProcessorsApiAxiosParamCreator)(configuration).stripeControllerCreateStripeConnectAccount(merchantId, options)];
                        case 1:
 ...
 * @export
 */
var ProcessorsApiFactory = function (configuration, basePath, axios) {
    return {
        /**
         *
         * @summary Create a new Stripe Connect account
        ...
        stripeControllerCreateStripeConnectAccount: function (merchantId, options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, (0, exports.ProcessorsApiFp)(configuration).stripeControllerCreateStripeConnectAccount(merchantId, options).then(function (request) { return request(axios, basePath); })];
                });
            });
        },
    };
 ...
 * @extends {BaseAPI}
 */
var ProcessorsApi = /** @class */ (function (_super) {
    __extends(ProcessorsApi, _super);
    function ProcessorsApi() {
     ...
     */
    ProcessorsApi.prototype.stripeControllerCreateStripeConnectAccount = function (merchantId, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, exports.ProcessorsApiFp)(this.configuration).stripeControllerCreateStripeConnectAccount(merchantId, options).then(function (request) { return request(_this.axios, _this.basePath); })];
            });
        });
    };
