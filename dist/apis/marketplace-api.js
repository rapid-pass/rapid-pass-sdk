...
exports.MarketplaceApi = exports.MarketplaceApiFactory = exports.MarketplaceApiFp = exports.MarketplaceApiAxiosParamCreator = void 0;
 ...
 * @export
 */
var MarketplaceApiAxiosParamCreator = function (configuration) {
    var _this = this;
    return {
        /**
         *
 ...
 * @export
 */
var MarketplaceApiFp = function (configuration) {
    return {
        /**
         *
         * @summary Get merchant info
        ...
        merchantsControllerGetSlug: function (slug, options) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, exports.MarketplaceApiAxiosParamCreator)(configuration).merchantsControllerGetSlug(slug, options)];
                        case 1:
                            localVarAxiosArgs = _a.sent();
                            return [2 /*return*/, function (axios, basePath) {
                                    if (axios === void 0) { axios = axios_1.default; }
 ...
 * @export
 */
var MarketplaceApiFactory = function (configuration, basePath, axios) {
    return {
        /**
         *
         * @summary Get merchant info
        ...
        merchantsControllerGetSlug: function (slug, options) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, (0, exports.MarketplaceApiFp)(configuration).merchantsControllerGetSlug(slug, options).then(function (request) { return request(axios, basePath); })];
                });
            });
        },
    };
 ...
 * @extends {BaseAPI}
 */
var MarketplaceApi = /** @class */ (function (_super) {
    __extends(MarketplaceApi, _super);
     ...
     * @memberof MarketplaceApi
     */
    MarketplaceApi.prototype.merchantsControllerGetSlug = function (slug, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, (0, exports.MarketplaceApiFp)(this.configuration).merchantsControllerGetSlug(slug, options).then(function (request) { return request(_this.axios, _this.basePath); })];
            });
        });
    };
